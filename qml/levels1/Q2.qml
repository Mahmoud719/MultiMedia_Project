...
Item {
    ...
    Text {
        ...
        y:30
        id: header1
        text: qsTr("choose  photo  start aletter 'f'")
        font.pixelSize: 20
    ...
    Rectangle
            {
              ...
              Image {
                  ...
                  width: 90
                  height: 90
                  source: "../../assets/img/png-clipart-orange-and-brown-fox-cartoon-fox-illustration-fox-pattern-purple-mammal-thumbnail.png"
